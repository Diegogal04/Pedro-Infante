...
router.get('/capitulos/episodio-8', ensureAuthenticated, (req, res) => {
    res.render('ep8.ejs')
})

router.get('/capitulos/episodio-9', ensureAuthenticated, (req, res) => {
    res.render('ep9.ejs')
})

router.get('/capitulos/episodio-10', ensureAuthenticated, (req, res) => {
    res.render('ep10.ejs')
})

router.get('/capitulos/episodio-11', ensureAuthenticated, (req, res) => {
    res.render('ep11.ejs')
})
